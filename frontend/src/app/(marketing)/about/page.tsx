            ...
            <div className="grid gap-8 md:grid-cols-2 items-center">
              <div className="space-y-4 font-serif text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  ...
                  distraction-free environment where ideas can flourish. In a
                  world of noise, we believe in the power of written words to
                  connect, inspire, and transform.
                </p>
                <p className="leading-relaxed">
                  We focus on typography, readability, and community, ensuring
                  that your stories are presented in the best possible light.
                </p>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div className="flex-1 space-y-4 text-center md:text-left font-serif">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    intersection of modern web technology and classic
                    storytelling. I&apos;m passionate about building clean,
                    accessible, and performant web applications that solve real
                    problems.
                  </p>

                  <p className="text-muted-foreground leading-relaxed">
                    This project showcases my expertise in Next.js, React,
                    Supabase, and modern UI design. I&apos;m always looking for
                    new challenges and opportunities to collaborate.
                  </p>
