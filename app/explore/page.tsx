  ...
  const filterAndSortPosts = () => {
    ...
    switch (sortBy) {
      case 'trending':
        ...
        break;
      case 'popular':
        filtered.sort((a, b) => (b.likes?.[0]?.count || 0) - (a.likes?.[0]?.count || 0));
        break;
      case 'latest':
      default:
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Explore the latest posts from our community of writers and find your next favorite read.
          </p>
        </motion.div>
          ...
          <Card className="glass">
            <CardContent className="p-6">
              <div className="flex flex-col lg:flex-row gap-4">
                ...
                {/* Sort Tabs */}
                <Tabs value={sortBy} onValueChange={(value) => setSortBy(value as any)} className="w-full lg:w-auto">
