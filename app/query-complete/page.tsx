  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">
        Supabase Query Builder - All Tables
      </h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {(Object.keys(SCHEMA) as TableName[]).map((table: TableName) => (
                <button
                  key={table}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm space-y-1 max-h-64 overflow-y-auto">
                {SCHEMA[selectedTable].columns.map((col: string) => (
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            ...
            <div className="space-y-2">
              {SCHEMA[selectedTable].samples.map(
          ...
          {queryHistory.length > 0 && (
            <div className="bg-white p-6 rounded-lg border shadow-sm">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {queryHistory.map((query: QueryResult, index: number) => (
                  <button
                    key={index}
                    onClick={() => {
